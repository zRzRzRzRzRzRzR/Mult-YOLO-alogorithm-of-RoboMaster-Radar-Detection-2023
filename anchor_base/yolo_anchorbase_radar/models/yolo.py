...
class Model(nn.Module):
    def __init__(self, cfg='yolov8n.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, DownC,
