...
##### 我们使用过的模块 #####
from models.Models.ConvNext import CNeB
from models.Models.ConvNext_v2 import CNeB2
...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=FReLU, drop=0.):
        ...
        if act_layer is ['FReLU']:
            self.act = act_layer(c1=hidden_features)
        else:
            self.act = act_layer()
