...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            out, train_out = model(img) if compute_loss else (model(img, augment=augment), None)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/armor-radar.yaml', help='*.data path')
    ...
    parser.add_argument('--project', default='/root/autodl-tmp/yolov7_radar/runs/test', help='save to project/name')
