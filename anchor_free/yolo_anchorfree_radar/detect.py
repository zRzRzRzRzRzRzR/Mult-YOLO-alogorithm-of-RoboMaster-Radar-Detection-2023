...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='../radar_detect/runs/train/exp/weights/best.pt',help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/media/zr/Data/RoboMaster_data/RMvideos/radar_record_2023/1_video_left.avi', help='source')
    parser.add_argument('--img-size', nargs='+', type=int, default=1280, help='inference size (pixels)')
    ...
    parser.add_argument('--project', default='../armor_backup/runs/detect', help='save to project/name')
