...
if __name__ == '__main__':
    ...
    parser.add_argument('--all_dir', type=str, default='/media/zr/Data/RoboMaster_data/dataset/XJTLU_2023_radar_ALL/', help='Location of the original all datasets')
    parser.add_argument('--split_dir', type=str, default='/media/zr/Data/RoboMaster_data/dataset/XJTLU_radar/', help='Output location of the split dataset')
