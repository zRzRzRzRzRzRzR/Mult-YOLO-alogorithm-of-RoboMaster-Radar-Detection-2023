...
def xywh2xyxy(img, xywh):
    ...
    landmarks = xywh[5:]
    names = ['B1', 'B2', 'B3', 'B4', 'B5', 'BO', 'BS', 'R1', 'R2', 'R3', 'R4', 'R5', 'RO', 'RS','BB','RB']
...
def deal_txt(pic1, txt_path):
    ...
    cv2.imshow('label_show_sample.jpg', pic)
    cv2.waitKey(0)

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--img_path', type=str, default='/media/zr/Data/RoboMaster_data/dataset/XJTLU_radar/images/train/6322.jpg', help='image dir')
    parser.add_argument('--txt_path', type=str, default='/media/zr/Data/RoboMaster_data/dataset/XJTLU_radar/labels/train/6322.txt', help='txt dir')
