...
def rename(path, start_id):
    file_list = sorted(os.listdir(path), key=lambda x: (x[:-4]))  # 在这里修改排序规则
    os.chdir(path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_dir', type=str, default='/media/zr/Data/RoboMaster_data/dataset/radar_0709/labels', help='Location of path')
