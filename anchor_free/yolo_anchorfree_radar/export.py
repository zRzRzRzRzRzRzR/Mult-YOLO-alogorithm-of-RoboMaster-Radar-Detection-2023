...
if __name__ == '__main__':
    ...
    parser.add_argument('--onnx-version', type=int, default=15, help='conf threshold for NMS')
    ...
    try:
        ...
        torch.onnx.export(model, img, f, verbose=False, opset_version=opt.onnx_version, input_names=['images'],
